...
def build_quadtree(analyzer, box, threshold, depth, max_depth):
    ...
    # Increase the minimum block size to 8 to prevent excessive drawing
...
def build_kdtree(analyzer, box, threshold, depth, max_depth):
    ...
    # Increase the minimum block size to 8
...
class ImageCompressorApp:
    ...
    def run_compression(self):
        ...
        if algo == "Uniform Grid":
            ...
            # --- NEW THRESHOLD SCALING ---
            # Map 1-100 to a more sensible range, e.g., 10-200
            # This prevents the threshold from ever being meaninglessly low.
            percent = (threshold - 1) / 99.0  # 0.0 to 1.0
            qt_threshold = int(10 + percent * 190) # Maps 1->10 and 100->200
            ...
            # --- NEW THRESHOLD SCALING ---
            percent = (threshold - 1) / 99.0  # 0.0 to 1.0
            kdt_threshold = int(10 + percent * 190) # Maps 1->10 and 100->200
